...
export const getMyBidListOnMapPage = ({
  blockX,
  blockY,
  applicant,
  callback,
...
export const updateMyLandState = ({
  userUUID,
  forSale,
  salePrice,
  gridId,
...
export const checkPhoneNumberDuplicate = ({
  phone,
  country_dial,
  callback,
}) => {
...
export const addEventTargetUser = ({
  swId,
  phone,
  email,
  birthday,
