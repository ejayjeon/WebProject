      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        ...
        >
          ...
          >
            ...
            >
              메타버스 프랫폼 '이루고 월드'는 가상세계와 현실 세계가 이어지는
              함께 꿈을 실현하는 곳입니다.
            </div>
            <div
              style={{
            ...
            >
              인간을 오직 한 단어로 정의 내릴 수 없듯 우리 '이루고 월드'도
              그렇습니다.
            </div>
          </div>
...
가진 이루고월드는 독자적인 경제 생태계를 통해 지속적인 성장을 추구합니다.`}</p>
              </div>
            </div>
          </div>
          <div style={{ width: "100%", height: "80px" }}></div>
          ...
          <div style={{ width: "100%" }}>
                ...
                >
                  ...
                  >
                    <div style={{ fontSize: "16px" }}>
                      메타버스 내 부동산, 상품, 용역, 아이템
                    </div>
                    <div style={{ fontSize: "16px" }}>
                      등을 거래할 수 있는 가상 자산입니다.
                    </div>
                  </div>
                </div>
                <div
            ...
            >
              ...
              >
                <div style={{ fontSize: "16px" }}>
                  메타버스 내에서 다양한 작업과 노력을 통해서 유저가 벌어들인 룩
                  토큰은 언제든지 EWC로
                </div>
                <div style={{ fontSize: "16px" }}>
                  이루고월드 환율 정책에 의해 교환할 수 있으며, EWC를
                  매각함으로써 현금화가 가능합니다.
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                <div style={{ fontSize: "16px" }}>
                  이루고월드 내에서 입점 업체가 내는 입점비, 광고비, 판매 수익
                  등은 루고 형태로 유통되어
                </div>
                <div style={{ fontSize: "16px" }}>
                  이루고월드의 경제 생태계를 발전시키게 됩니다.
                </div>
              </div>
            </div>
            <div style={{ width: "100%", height: "40px" }}></div>
