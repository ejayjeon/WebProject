                  ...
                  <ExchangCoin
                    ...
                    onClick={({ withdrawCoin }) => {
                      ...
                      if (withdrawCoin > 0 && withdrawCoin <= coin) {
                          ...
                          callback: (err, result) => {
                            if (err) {
                              ...
                              setSMSRequestShow({
                                ...
                                text: "SecurityWallet으로 부터 EWC를 가져오기 위해 휴대폰 인증을 진행합니다.",
                                callback: (isOK) => {
                                  setSMSRequestShow({
                                    display: false,
                                    authKey: undefined,
                        ...
                        if (parseInt(coin) > 0) {
                          window.alert(
                            `이루고 월드로 가져올 코인은 [ 0 ]개보다 크고 [ ${Number(
                              coin
                            )} ] 개(보유한 코인 갯수) 보다 작아야 합니다.`
                          );
                        } else {
                          window.alert(`현재 보유한 코인이 없습니다`);
                        }
                      }
                    }}
                  />
                          ...
                          callback: (err, result) => {
                            if (err) {
                              ...
                              setSMSRequestShow({
                                display: true,
                                authKey: result.message.authkey,
                                text: "EWC를 RUGO로 전환하기 위해 휴대폰 인증을 진행합니다.",
                                callback: (isOK) => {
                                  setSMSRequestShow({
                                    display: false,
                                    authKey: undefined,
